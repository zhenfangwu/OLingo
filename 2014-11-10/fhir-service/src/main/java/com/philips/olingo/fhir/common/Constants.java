...
//	static final String URL_OBSERVATION = "http://www.hl7.org/implement/standards/FHIR-Develop/deviceobservationreport-example.json";
	static final String URL_PATIENT = "http://demo33-prod.apigee.net/fhir-patient";
	static final String URL_OBSERVATION = "http://demo33-prod.apigee.net/fhir-observation";
