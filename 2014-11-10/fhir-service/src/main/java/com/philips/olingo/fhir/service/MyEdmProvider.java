...
//						.setFacets(new Facets().setNullable(true).setMaxLength(80)));
				...
				properties.add(new SimpleProperty().setName("observationUnit").setType(EdmSimpleTypeKind.String)
						.setFacets(new Facets().setNullable(true).setMaxLength(80)));
				properties.add(new SimpleProperty().setName("patientRef").setType(EdmSimpleTypeKind.String)
						.setFacets(new Facets().setNullable(false).setMaxLength(80)));

				//Navigation Properties
				List<NavigationProperty> navigationProperties = new ArrayList<NavigationProperty>();
				navigationProperties.add(new NavigationProperty().setName("Patient")
						.setRelationship(ASSOCIATION_OB_PATIENT).setFromRole(ROLE_OB_P).setToRole(ROLE_P_OBS));
